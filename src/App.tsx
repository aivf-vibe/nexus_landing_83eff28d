    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-600">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <motion.div 
            className="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20 shadow-xl"
            variants={fadeInUp}
      ...
      >
        <motion.div 
          className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 shadow-2xl p-8 md:p-12 text-center"
          variants={fadeInUp}
        >
          <motion.h2 
          ...
          >
            <motion.button 
              onClick={handleGetStarted}
              className="bg-white text-emerald-600 px-8 py-3 rounded-full font-semibold hover:bg-emerald-50 transition-all focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 shadow-lg min-w-[200px]"
            ...
            <motion.button 
              onClick={handleGetStarted}
              className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition-all focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 shadow-lg min-w-[200px]"
      ...
      >
        <motion.div 
          className="grid grid-cols-1 md:grid-cols-4 gap-8 border-t border-white/20 pt-12"
          variants={fadeInUp}
        >
          {/* Company Info */}
          <motion.div 
